...
declare module cc {	
	...
	*/
	...
	export enum RayCastType {		
		...
		*/
		onBeginContact(contact : PhysicsContact, selfCollider : PhysicsColider, otherCollider : PhysicsColider) : void;		
		/** !#en
		Collision callback.
		...
		@param otherCollider the collider belong to another rigidbody 
		*/
		onEndContact(contact : PhysicsContact, selfCollider : PhysicsColider, otherCollider : PhysicsColider) : void;		
		/** !#en
		Collision callback.
		...
		@param otherCollider the collider belong to another rigidbody 
		*/
		onPreSolve(contact : PhysicsContact, selfCollider : PhysicsColider, otherCollider : PhysicsColider) : void;		
		/** !#en
		Collision callback.
		...
		@param otherCollider the collider belong to another rigidbody 
		*/
		onEndSolve(contact : PhysicsContact, selfCollider : PhysicsColider, otherCollider : PhysicsColider) : void;		
		/** !#en
	...
	export enum TextAlignment {		
		...
		*/
		...
		export class PhysicsBoxCollider extends BoxCollider {	
	}		
		/** !#en
		...
		!#zh
		PhysicsPolygonCollider 同样也继承自 {{#crossLink "PhysicsCollider"}}PhysicsCollider{{/crossLink}} */
		export class PhysicsCircleCollider extends PolygonCollider {	
	}		
		/** undefined */
		...
		*/
		...
		!#zh
		PhysicsPolygonCollider 同样也继承自 {{#crossLink "PhysicsCollider"}}PhysicsCollider{{/crossLink}} */
		export class PhysicsPolygonCollider extends PolygonCollider {	
	}		
		/** !#en
